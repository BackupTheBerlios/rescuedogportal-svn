...
<table width="100%" border="0" cellspacing="1" cellpadding="5" class="tableinborder">
	<tr>
		<td align="center" class="table_title"><span class="normalfont"><b>Impressum der RHS BRK Ansbach</b></span></td>
	</tr>
</table>
<br />
	...
	<tr>
		<td class="tableb"> 				
			<p style="alignment:justify; text-align:justify">
				...
				<b>1. Inhalt des Onlineangebotes </b><br /><br />			
			...
			<p style="alignment:justify; text-align:justify">
				<span class="normalfont">
				<b>2. Verweise und Links  </b><br /><br />			
				Bei direkten oder indirekten Verweisen auf fremde 
				Internetseiten ("Links"), die außerhalb des Verantwortungsbereiches des Autors liegen, würde 
				eine Haftungsverpflichtung ausschließlich in dem Fall in Kraft treten, in dem der Autor von den 
				Inhalten Kenntnis hat und es ihm technisch möglich und zumutbar wäre, die Nutzung im Fall 
				rechtswidriger Inhalte zu verhindern. 
				Der Autor erklärt daher ausdrücklich, dass zum Zeitpunkt der Linksetzung die entsprechenden 
				verlinkten Seiten frei von illegalen Inhalten waren. Der Autor hat keinerlei Einfluss auf die aktuelle 
				und zukünftige Gestaltung und auf die Inhalte der gelinkten/verknüpften Seiten. Deshalb distanziert 
			...
			<p style="alignment:justify; text-align:justify">
				<span class="normalfont">
				<b>3. Urheber- und Kennzeichenrecht  </b><br /><br />				
				...
				der bloßen Nennung ist nicht der Schluß zu ziehen, dass Markenzeichen nicht durch Rechte Dritter 
				geschützt sind! 
			...
			<p style="alignment:justify; text-align:justify">
				<span class="normalfont">
				<b>5. Rechtswirksamkeit dieses Haftungsausschlusses  </b><br /><br />				
