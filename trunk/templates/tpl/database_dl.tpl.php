...
{section name=outer loop=$linkref}
	<tr>
		<td class="tableb" width="50%">
			<span class="normalfont"><a href="database.php?tempid=dlfile&id={$linkref[outer].id}{$url_und_sid}" target="_blank"><b>{$linkref[outer].dlname}</b></a></span><br />
			<span class="smallfont">{$linkref[outer].dldescription}</span>
		</td>  		
	</tr>
{sectionelse}
	<tr>
