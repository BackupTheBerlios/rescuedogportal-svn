...
<table cellpadding=4 cellspacing=1 border=0 class="tblborder" width="100%" align="center">
	<form action="training_trainer.php?action={$action}&id={$id}{$url_und_sid}" method="post">
	<tr class="tblhead">
		<td colspan="2">Admin Trainer</td>
	</tr>
	{if $fehler == 1} 
	...
	<tr>
		...
		<td width="85%" class="tblsection" align="left"><input type="text" name="p_trainer" style="width:100%" value="{$trainer}"/></td>
	</tr>
	<tr class="tblsection">
