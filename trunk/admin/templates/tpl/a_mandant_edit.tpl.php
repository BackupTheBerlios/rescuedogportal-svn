...
<table cellpadding=4 cellspacing=1 border=0 class="tblborder" width="100%" align="center">
	<form action="mandant.php?action={$action}&id={$mandant_id2}{$url_und_sid}" name="bbform" method="post" onsubmit="return validate(this)">
	<tr class="tblhead">
		<td colspan="2">Admin Mandant</td>
	</tr>
	{if $fehler == 1} 
	...
	<tr>
		...
		<td width="85%" class="tblsection" align="left"><input type="text" name="mandant_name" style="width:100%" value="{$mandant_name2}"/></td>
	</tr>
	<tr>
		<td width="15%" class="tblsectionhead" align="left">EMail</td>
		<td width="85%" class="tblsection" align="left"><input type="text" name="mandant_email" style="width:100%" value="{$mandant_email2}"/></td>
	</tr>
	<tr>
		<td width="15%" class="tblsectionhead" align="left">Verantwortlicher: Vorname</td>
		<td width="85%" class="tblsection" align="left"><input type="text" name="mandant_vorname" style="width:100%" value="{$mandant_vorname2}"/></td>
	</tr>
	<tr>
		<td width="15%" class="tblsectionhead" align="left">Verantwortlicher: Nachname</td>
		<td width="85%" class="tblsection" align="left"><input type="text" name="mandant_nachname" style="width:100%" value="{$mandant_nachname2}"/></td>
	</tr>
	<tr><td colspan="2" class="tblsectionhead">Bank</td></tr>
	<tr>
		<td width="25%" class="tblsectionhead">Bakverbindung auf der Website anzeigen:</td>
		<td width="75%"  class="tblsection"><select name="mandant_show_konto">{$mandant_show_konto2}</select></td>
	</tr>
	<tr>
		<td width="15%" class="tblsectionhead" align="left">Konto NR</td>
		<td width="85%" class="tblsection" align="left"><input type="text" name="mandant_konto_nr" style="width:100%" value="{$mandant_konto_nr2}"/></td>
	</tr>
	<tr>
		<td width="15%" class="tblsectionhead" align="left">BLZ</td>
		<td width="85%" class="tblsection" align="left"><input type="text" name="mandant_konto_blz" style="width:100%" value="{$mandant_konto_blz2}"/></td>
	</tr>
	<tr>
		<td width="15%" class="tblsectionhead" align="left">Bank</td>
		<td width="85%" class="tblsection" align="left"><input type="text" name="mandant_konto_bank" style="width:100%" value="{$mandant_konto_bank2}"/></td>
	</tr>
	<tr><td colspan="2" class="tblsectionhead">Settings</td></tr>
	<tr>
		<td width="25%" class="tblsectionhead">Kontakte auf der Website anzeigen:</td>
		<td width="75%"  class="tblsection"><select name="mandant_show_kontakt">{$mandant_show_kontakt2}</select></td>
	</tr>	
	<tr>
		<td width="25%" class="tblsectionhead">Staffeldaten auf der Website anzeigen:</td>
		<td width="75%"  class="tblsection"><select name="mandant_show_index_start">{$mandant_show_index_start2}</select></td>
	</tr>
	<tr>
		<td width="25%" class="tblsectionhead">Portal auf der Website anzeigen:</td>
		<td width="75%"  class="tblsection"><select name="mandant_show_index_portal">{$mandant_show_index_portal2}</select></td>
	</tr>
	<tr>
		<td width="25%" class="tblsectionhead">Projekte auf der Website anzeigen:</td>
		<td width="75%"  class="tblsection"><select name="mandant_show_index_projects">{$mandant_show_index_projects2}</select></td>
	</tr>
	<tr>
		<td width="25%" class="tblsectionhead">Sponsoren auf der Website anzeigen:</td>
		<td width="75%"  class="tblsection"><select name="mandant_show_index_sponsors">{$mandant_show_index_sponsors2}</select></td>
	</tr>
	<tr>
		<td colspan="2" width="100%" class="tblsection" align="left">	
			...
			{/literal}
			<br />
    	<input type="hidden" name="message" value="{$mandant_staffeltext2}" />
		</td>
	</tr>
	<tr class="tblsection">
