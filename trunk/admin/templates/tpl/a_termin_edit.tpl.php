...
<table cellpadding=4 cellspacing=1 border=0 class="tblborder" width="100%" align="center">
	<form action="termin.php?action={$action}&id={$id}{$url_und_sid}" name="bbform" method="post" onsubmit="return validate(this)">
	<tr class="tblhead">
		<td colspan="2">Admin Termine und Berichte</td>
	</tr>
	{if $fehler == 1} 
	...
	<tr>
		<td width="15%" class="tblsectionhead" align="left">Ort</td>
		<td width="85%" class="tblsection" align="left"><input type="text" name="ort" style="width:100%" value="{$ort}"/></td>
	</tr>
	<tr>
		<td width="15%" class="tblsectionhead" align="left">Datum und Uhrzeit: Start</td>
		<td width="85%" class="tblsection" align="left"><input type="text" name="datum" style="width:100%" value="{$datefrom|date_format:"%d.%m.%Y"}"/></td>
	</tr>
	<tr>
		<td width="15%" class="tblsectionhead" align="left">Datum und Uhrzeit: Ende</td>
		<td width="85%" class="tblsection" align="left"><input type="text" name="datumbis" style="width:100%" value="{$dateto|date_format:"%d.%m.%Y"}"/></td>
	</tr>
	<tr>
		<td colspan="2" width="100%" class="tblsection" align="left">	
			...
			{/literal}
			<br />
    	<input type="hidden" name="message" value="{$beschreibung}" /></td>
	</tr>
	<tr class="tblsection">
